package com.example.ihjohny.trackyourself.ui.today;
    ...
    private void loadData() {
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                dataList.add(new Task(cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6), cursor.getString(7), cursor.getString(8), cursor.getString(9), cursor.getString(10)));
            }
        }
    }
...
/*                int position_dragged = dragged.getAdapterPosition();
                ...
                Task data_dragged = dataList.get(position_dragged);
                Task data_target = dataList.get(position_target);
