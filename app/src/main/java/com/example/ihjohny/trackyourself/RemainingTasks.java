...
public class RemainingTasks extends AppCompatActivity {
    ...
    private ArrayList<DataSet> dataList=new ArrayList<>();
    private ArrayList<DataSet> dataList1=new ArrayList<>();
    private ArrayList<DataSet> dataList2=new ArrayList<>();
    private List<SimpleSectionedRecyclerViewAdapter.Section> sections =
            new ArrayList<SimpleSectionedRecyclerViewAdapter.Section>();
    ArrayList<DataSet>  remainingTaskDataList=new ArrayList<>();
    ...
    private void loadRemainingTasksData()
    {
        ...
        if(intentTitle.equals("Previous Tasks")) {
          ...
          //      if(cursor.getString(9).equals("1") )
                {
                    //remainingTaskDataList.add(new DataSet(cursor.getString(0),cursor.getString(1),cursor.getString(2),cursor.getString(3),cursor.getString(4),cursor.getString(5),cursor.getString(6),cursor.getString(7),cursor.getString(8),cursor.getString(10)));
                    DataSet dataSetForDate=new DataSet(cursor.getString(0),cursor.getString(1),cursor.getString(2),"date",cursor.getString(4),cursor.getString(5),cursor.getString(6),cursor.getString(7),cursor.getString(8),cursor.getString(9),cursor.getString(10));
                    ...
                    {
                        dataList2.add(dataSetForDate);
                        dataList1.add(dataSetForDate);
                        date=cursor.getString(6)+cursor.getString(7)+cursor.getString(8);
                    }
                    else
                        dataList1.add(dataSet);
                    dataList2.add(dataSetForDate);
